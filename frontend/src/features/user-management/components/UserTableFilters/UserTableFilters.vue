...
import type { UserManagementSearchField } from "@/features/user-management/types";
...
<template>
  <div
    ...
    <div class="space-y-1">
      <label for="position-filter" class="text-sm font-medium text-brand-darker">Role</label>
      <select
        id="position-filter"
